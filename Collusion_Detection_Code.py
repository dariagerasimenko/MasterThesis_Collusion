...
def predict_collusion_company(df, dataset, predictors_column_name, targets_column_name, algorithm, train_size, n_estimators=None):
    ...
    if algorithm == 'ExtraTreesClassifier':
        ...
        classifier = GradientBoostingClassifier(loss='log_loss', learning_rate=learning_rate, n_estimators=estimators, subsample=1.0, criterion='friedman_mse', min_samples_split=2, min_samples_leaf=1,
                            min_weight_fraction_leaf=0.0, max_depth=None, min_impurity_decrease=0.0, init=None, random_state=None, max_features=None, verbose=0,
